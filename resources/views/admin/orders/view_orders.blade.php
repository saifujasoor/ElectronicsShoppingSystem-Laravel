...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a>View Orders</a> <a class="current">View Orders</a> </div>
      <h1>View Orders</h1>
                ...
                @foreach ($orderdata as $order)
                    <tr class="gradeX">
                        ...
                        <td class="center">
                          ...
                          <a href="{{ url('/admin/edit-order-status/'.$order->id) }}" class="btn btn-primary btn-mini">Edit Order status</a> 
                    </tr>  
                @endforeach      
                </tbody>
              </table>
